...
CORE_1_MARKET_BASICS.md) — nothing here invents lesson content.
...
[DONE] / [ ] status legend:
  - AUTHORED stages: real content_body, parsed directly out of the
    two .md files that have full lessons written (PART_0, CORE_1).
...
async def seed_curriculum():
    ...
    authored = {**orient_lessons, **core1_lessons}
